    ...
    const Details = () => <>
        ...
        <ElevatedBox>
            ...
            <Rows style={{marginTop: 20}}>
                <Button onClick={onEditClick} label="Edit" disabled={typeof data === "undefined"}/>
                <Button onClick={() => onGoToFlow(data.id)}
                                       icon={<IoGitNetworkSharp size={20} style={{marginRight: 5}}/>}
                                       label="Go to FLOW"
                                       disabled={typeof data === "undefined"}/>
                {onDeleteComplete && <Button onClick={onDelete} label="Delete" disabled={typeof data === "undefined"}/>}
            </Rows>
        </ElevatedBox>
