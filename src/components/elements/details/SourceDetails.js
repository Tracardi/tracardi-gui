...
export default function SourceDetails({ id, onDeleteComplete }) {
  ...
  const Details = () => (
    <>
      ...
      {data.type === "web-page" && (
        <React.Fragment>
          <FormHeader>Integration</FormHeader>
          <ElevatedBox>
            <FormSubHeader>Javascript code</FormSubHeader>
            <FormDescription>
              Please paste this code into your web page. This code should appear
              on every page.
            </FormDescription>
          ...
          <ElevatedBox>
            ...
            <FormDescription>
              Please refer to Tracardi documentation on more complex
              configuration.
            </FormDescription>
          </ElevatedBox>
        </React.Fragment>
